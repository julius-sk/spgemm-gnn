...
class TrainConfig(BaseConfig):
    def build_parser(self):
        ...
        parser.add_argument('--cache-strategy', type=str, default='none',
                            choices=['none', 'direct', 'static-outd', 'static-pres', 'fifo', 'lru'],
                            help='Cache strategy to use')
        parser.add_argument('--cache-size-ratio', type=float, default=0.05,
                            help='Ratio of nodes to cache (between 0 and 1)')
        return parser
